...
sed -E -e 's|"./vendor/bin/npm install --before 2025-09-14"|"./vendor/bin/npm install --only=production --before 2025-09-14"|' "${originalPath}/composer.json" > "${buildPath}/composer.json"
...
readFileUntilMark "${originalPath}/src/js/INTER-Mediator-Auth.js" "${buildPath}/src/js/temp.js"
readFileUntilMark "${originalPath}/src/js/INTER-Mediator-AuthUI.js" "${buildPath}/src/js/temp.js"
